"""
Django settings for restless_violet_41642 project.
...
ROOT_URLCONF = 'restless_violet_41642.urls'
...
WSGI_APPLICATION = 'restless_violet_41642.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_violet_41642 API",
    "DESCRIPTION": "API documentation for restless_violet_41642 App",
    "VERSION": "v1",
}
